export default class socials {
  ...
  onClickbird() {
    let link =
      "https://twitter.com/share?text=I%20just%20got%20a%20score%20of%20" +
      this.score +
      "%20on%20%40LaundrOfficial%27s%20hidden%20%23laundr404game%21%0A%0AThink%20you%20can%20do%20better%3F%20Take%20it%20for%20a%20spin%20here%3A";
  ...
  onClickthumbsupShare() {
    ...
    let link =
      "https://www.facebook.com/sharer/sharer.php?u=https%3A%2F%2Fwww.laundr.io%2F404&amp;src=sdkpreparse";
  ...
  renderTwt() {
    if (!this.adBlock) {
      ...
      this.twtDiv.innerHTML = "";
      let text =
        `I just got a score of ` +
        this.score +
        ` on @LaundrOfficial's hidden #laundr404game!\n\nThink you can do better? Take it for a spin here:\n`;
      twttr.widgets.createShareButton(
        "https://www.laundr.io/404",
        this.twtDiv,
        {
          text: text,
        }
